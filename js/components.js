	...
	var RankColumn = React.createClass({displayName: "RankColumn",
		render: function () {
			...
			var playerNodes = sortedPlayers.map(function (player) {
				return (
					React.createElement(RankPlayer, {player: player, showField: sortby, highlighted: highlighted, 
				...
				React.createElement("div", {className: "row"}, 
					...
					React.createElement("div", {className: "col-xs-5", id: "global-rank"}, 
						React.createElement("div", null, 
							...
							React.createElement(RankColumn, {players: players, sortby: "rank_fp", highlighted: this.state.highlighted, 
					...
					React.createElement("div", {className: "col-xs-5", id: "global-adp"}, 
						React.createElement("div", null, 
							...
							React.createElement(RankColumn, {players: players, sortby: "adp_fp", highlighted: this.state.highlighted, 
										onPlayerMouseOver: this.highlightPlayer})
						)
					), 
					...
					React.createElement("div", {className: "col-xs-5", id: "espn-adp"}, 
						React.createElement("div", null, 
							...
							React.createElement(RankColumn, {players: players, sortby: "adp_espn", highlighted: this.state.highlighted, 
										onPlayerMouseOver: this.highlightPlayer})
						)
					), 
					...
					React.createElement("div", {className: "col-xs-5", id: "espn-rank"}, 
						React.createElement("div", null, 
							...
							React.createElement(RankColumn, {players: players, sortby: "rank_espn", highlighted: this.state.highlighted, 
										onPlayerMouseOver: this.highlightPlayer})
						)
					), 
					...
					React.createElement("div", {className: "col-xs-5", id: "espn-rank-qb"}, 
						React.createElement("div", null, 
							...
							React.createElement(RankColumn, {players: players, sortby: "rank_espn", filter: filters.qb, 
										highlighted: this.state.highlighted, onPlayerMouseOver: this.highlightPlayer})
						), 

						React.createElement("div", null, 
							React.createElement("h4", null, "ESPN TE RANK"), 
							React.createElement(RankColumn, {players: players, sortby: "rank_espn", filter: filters.te, 
										highlighted: this.state.highlighted, onPlayerMouseOver: this.highlightPlayer})
						)
					...
					React.createElement("div", {className: "col-xs-5", id: "espn-rank-rb"}, 
						React.createElement("div", null, 
							...
							React.createElement(RankColumn, {players: players, sortby: "rank_espn", filter: filters.rb, 
										highlighted: this.state.highlighted, onPlayerMouseOver: this.highlightPlayer})
						), 

						React.createElement("div", null, 
							React.createElement("h4", null, "ESPN DST RANK"), 
							React.createElement(RankColumn, {players: players, sortby: "rank_espn", filter: filters.dst, 
										highlighted: this.state.highlighted, onPlayerMouseOver: this.highlightPlayer})
						)
					), 
					...
					React.createElement("div", {className: "col-xs-5", id: "espn-rank-wr"}, 
						React.createElement("div", null, 
							...
							React.createElement(RankColumn, {players: players, sortby: "rank_espn", filter: filters.wr, 
										highlighted: this.state.highlighted, onPlayerMouseOver: this.highlightPlayer})
						), 

						React.createElement("div", null, 
							React.createElement("h4", null, "ESPN K RANK"), 
							React.createElement(RankColumn, {players: players, sortby: "rank_espn", filter: filters.k, 
										highlighted: this.state.highlighted, onPlayerMouseOver: this.highlightPlayer})
						)
					)
	...
	var DraftOrder = React.createClass({displayName: "DraftOrder",
		...
		render: function () {
			...
			var pickNodes = _.map(emptyPicks, function (pick) {
				...
				first = false;
				return (
					React.createElement("div", {className: "col-xs-6"}, React.createElement("span", {className: className}, React.createElement("span", {
						className: "num"}, pick.pickNum), pick.team.name))
				);
			});
			return (
	...
	var DraftTeamRoster = React.createClass({displayName: "DraftTeamRoster",
		render: function () {
			...
			var pickNodes = _.map(myPicks, function (pick) {
				...
				return (
					React.createElement("li", {className: "roster-position"}, React.createElement("span", {className: "num"}, pick.pickNum), img, React.createElement("span", {
						className: "name"}, pick.player ? pick.player.name + ', ' + pick.player.position : ''))
				);
			});
			...
			for (var i = 0; i < numTeams / 2; i++) {
				rosterColumns.push(
					React.createElement("div", {className: "col-xs-7"}, 
						...
						React.createElement(DraftTeamRoster, {picks: allPicks, team: this.state.teams[i + (numTeams / 2 )], 
