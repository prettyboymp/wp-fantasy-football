  ...
  var RankColumn = React.createClass({
    render:  function() {
      ...
      var playerNodes = sortedPlayers.map(function(player) {
        return (
            <RankPlayer player={player} showField={sortby} highlighted={highlighted} onPlayerMouseOver={onPlayerMouseOver} />
          );
      });
      ...
      return(
        <div className="row">
            ...
            <div className="col-xs-5" id="global-rank">
              <div>
                <h4>FP RANK</h4>
                <RankColumn players={players} sortby="rank_fp" highlighted={this.state.highlighted} onPlayerMouseOver={this.highlightPlayer} />
              </div>
            </div>
            ...
            <div className="col-xs-5" id="global-adp" >
              <div>
              <h4>FP ADP</h4>
              <RankColumn players={players} sortby="adp_fp" highlighted={this.state.highlighted} onPlayerMouseOver={this.highlightPlayer}  />
              </div>
            </div>
            ...
            <div className="col-xs-5" id="espn-adp">
              <div>
              <h4>ESPN ADP</h4>
              <RankColumn players={players} sortby="adp_espn" highlighted={this.state.highlighted} onPlayerMouseOver={this.highlightPlayer}  />
              </div>
            </div>
            ...
            <div className="col-xs-5" id="espn-rank">
              <div>
              <h4>ESPN RANK</h4>
              <RankColumn players={players} sortby="rank_espn" highlighted={this.state.highlighted} onPlayerMouseOver={this.highlightPlayer}  />
              </div>
            </div>
            ...
            <div className="col-xs-5" id="espn-rank-qb">
              <div>
                <h4>ESPN QB RANK</h4>
                <RankColumn players={players} sortby="rank_espn" filter={filters.qb} highlighted={this.state.highlighted} onPlayerMouseOver={this.highlightPlayer}  />
              </div>
          
              <div>
                <h4>ESPN TE RANK</h4>
                <RankColumn players={players} sortby="rank_espn" filter={filters.te} highlighted={this.state.highlighted} onPlayerMouseOver={this.highlightPlayer}  />
              </div>
            ...
            <div className="col-xs-5" id="espn-rank-rb">
              <div>
                <h4>ESPN RB RANK</h4>
                <RankColumn players={players} sortby="rank_espn" filter={filters.rb} highlighted={this.state.highlighted} onPlayerMouseOver={this.highlightPlayer}  />
              </div>
          
              <div>
                <h4>ESPN DST RANK</h4>
                <RankColumn players={players} sortby="rank_espn" filter={filters.dst} highlighted={this.state.highlighted} onPlayerMouseOver={this.highlightPlayer}  />
              </div>
            </div>
            ...
            <div className="col-xs-5" id="espn-rank-wr">
              <div>
                <h4>ESPN WR RANK</h4>
                <RankColumn players={players} sortby="rank_espn" filter={filters.wr} highlighted={this.state.highlighted} onPlayerMouseOver={this.highlightPlayer}  />
              </div>
          
              <div>
                <h4>ESPN K RANK</h4>
                <RankColumn players={players} sortby="rank_espn" filter={filters.k} highlighted={this.state.highlighted}  onPlayerMouseOver={this.highlightPlayer} />
              </div>
            </div>
  ...
  var DraftOrder = React.createClass({
    ...
    render: function() {
      ...
      var pickNodes = _.map(emptyPicks, function(pick) {
        ...
        first = false;
        return (
          <div className="col-xs-6"><span className={className}><span className="num">{pick.pickNum}</span>{pick.team.name}</span></div>
        );
      });
      return (
  ...
  var DraftTeamRoster = React.createClass({
    render: function() {
      ...
      var pickNodes = _.map(myPicks, function(pick) {
        ...
        return (
          <li className="roster-position"><span className="num">{pick.pickNum}</span>{img}<span className="name">{pick.player ? pick.player.name + ', ' + pick.player.position : ''}</span></li>
        );
      });
     ...
     for(var i = 0; i < numTeams/2; i++) {
       rosterColumns.push(
        <div className="col-xs-7">
          ...
          <DraftTeamRoster picks={allPicks} team={this.state.teams[i + (numTeams / 2 )]} currentPick={currentPick} />
        </div>
       );
     }
